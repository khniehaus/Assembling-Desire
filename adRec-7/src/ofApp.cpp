...
im2.loadImage("4.jpg"); //load sequence 4
im3.loadImage("5.jpg"); //load sequence 5

im1.resize(ofGetWidth(), ofGetHeight()); //resize image 1 to screen
im2.resize(ofGetWidth(), ofGetHeight()); //resize image 4 to screen
im3.resize(ofGetWidth(), ofGetHeight()); //resize image 5 to screen
